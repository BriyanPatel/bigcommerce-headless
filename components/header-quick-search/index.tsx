...
export const QuickSearch = ({ children, initialTerm = '' }: SearchProps) => {
  ...
  return (
    <Sheet onOpenChange={setOpen} open={open}>
      <SheetTrigger asChild>
        <Button
          ...
          className="search_btn border-0 bg-transparent p-3 text-black hover:bg-transparent hover:text-primary focus-visible:text-primary"
        >
          <div className="vwo_searchTop">
    ...
    <form className="search-box">
      ...
      <input
        type="text"
        placeholder="Search For Gun Model"
        className="search-input vwo_searchInput"
      />
      ...
      <SheetOverlay className="bg-transparent backdrop-blur-none">
        ...
        >
          ...
          {searchResults && searchResults.products.length > 0 && (
            <div className="mt-8 grid overflow-auto px-1 lg:grid-cols-3 lg:gap-6 search_result">
              <section>
              ...
              <section>
                ...
                <SheetClose asChild>
                <Link className="w-auto" href={`/search?term=${term}`}>
                View More
              </Link>
            </SheetClose>
              </section>
