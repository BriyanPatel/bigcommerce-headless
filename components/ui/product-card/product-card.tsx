...
const ProductCard = forwardRef<ElementRef<'div'>, ComponentPropsWithRef<'div'>>(
  ({ children, className, ...props }, ref) => {
    return (
      <div
        className={cn('card-item group relative flex flex-col overflow-visible', className)}
        ref={ref}
        {...props}
      >
        {children}
...
const ProductCardImage = forwardRef<ElementRef<'div'>, ComponentPropsWithRef<'div'>>(
  ({ children, className, ...props }, ref) => {
    return (
      <div className={cn('testtest relative flex justify-center pb-3', className)} ref={ref} {...props}>
        {children}
      </div>
    );
  },
...
const ProductCardInfo = forwardRef<ElementRef<'div'>, ComponentPropsWithRef<'div'>>(
  ({ children, className, ...props }, ref) => {
    return (
      <div className={cn('flex flex-1 flex-col gap-1 text-center')} ref={ref} {...props}>
        {children}
      </div>
    );
  },
...
const ProductCardInfoBrandName = forwardRef<ElementRef<'p'>, ComponentPropsWithRef<'p'>>(
  ({ children, className, ...props }, ref) => {
    return (
      <p className={cn('text-base text-gray-500 text-center', className)} {...props} ref={ref}>
        {children}
      </p>
    );
  },
...
const ProductCardInfoProductName = forwardRef<ElementRef<'h3'>, ComponentPropsWithRef<'h3'>>(
  ({ children, className, ...props }, ref) => {
    return (
      <h3 className={cn('card-title', className)} ref={ref} {...props}>
        {children}
      </h3>
    );
  },
...
const ProductCardInfoPrice = forwardRef<ElementRef<'div'>, ComponentPropsWithRef<'div'>>(
  ({ children, className, ...props }, ref) => {
    return (
      <div className={cn('price', className)} ref={ref} {...props}>
        {children}
      </div>
    );
  },
