...
const selectVariants = cva(
  'focus-visible:ring-primary/20 group flex h-12 w-full items-center justify-between border border-gray-200 px-4 py-3 text-base text-black hover:border-black focus-visible:border-black focus-visible:outline-none focus-visible:ring-4 disabled:bg-gray-100 disabled:hover:border-gray-200 data-[placeholder]:text-gray-500',
  {
    variants: {
      variant: {
        success:
