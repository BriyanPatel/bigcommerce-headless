...
export const RemoveButton = () => {
  ...
  return (
    <Button
      className="items-center w-auto p-0 text-primary hover:bg-transparent disabled:text-primary disabled:hover:text-primary"
      loading={pending}
      loadingText={t('spinnerText')}
      type="submit"
      variant="subtle"
...
export const CouponCode = ({ checkout }: Props) => {
  ...
  return selectedCoupon ? (
    <div className="flex flex-col gap-2 py-4 border-t border-t-gray-200 coupon-code">
    ...
    <div className="flex flex-col gap-2 py-4 border-t border-t-gray-200">
      <div className="flex justify-between">
        <span className="font-semibold">{t('couponCode')}</span>
        <Button
          aria-controls="coupon-code-form"
          className="p-0 w-fit text-primary hover:bg-transparent"
