...
const SubmitButton = ({ messages }: SumbitMessages) => {
  ...
  return (
    <div className="form-actions">
      <Button
        className="relative w-fit items-center button primary-btn"
        loading={pending}
...
export const RegisterCustomerForm = ({
  ...
  return (
    <>
      ...
      <Form action={onSubmit} className='form signup-form' ref={form}>
      <p className="reg-txt">To create a free account please fill in the information below.</p>
      <div className='form-row form-row--half'>
        <div className="mb-6 form-wrap grid grid-cols-1 gap-y-6 lg:grid-cols-2 lg:gap-x-6 lg:gap-y-2">
          {customerFields
        ...
        {reCaptchaSettings?.isEnabledOnStorefront && (
            <Field className="g-recaptcha" name="ReCAPTCHA">
              <ReCaptcha
