    ...
    <div>
      ...
      >
          <div className="grid grid-cols-4 gap-8">
            ...
            <section aria-labelledby="product-heading" className="col-span-4 lg:col-span-3 main-content">
                <div className="md:mb-8 lg:flex lg:flex-row lg:items-center lg:justify-between">
                  <h1 className="page-heading mb-0">{category.name}</h1>
              ...
              <div className="pro-card-wrap grid grid-cols-2 gap-6 sm:grid-cols-3 sm:gap-8 productGrid">
